    ...
    const fetchVMs = async () => {
      try {
        ...
        const res = await axios.get(
          `${BACKEND_URL}/vm/getAll?adminKey=${wallet?.publicKey}`,
          {
            headers: {
    ...
    try {
      switch (operation) {
        ...
        case "fund": {
          ...
          const resp = await FundVaultAccount(
            wallet!,
        ...
        case "withdraw": {
          ...
          const respo = await WithdrawFromVault(
            withdrawAmount,
            wallet!,
            data.secretKey,
          );
          ...
          toast.success(
            `${withdrawAmount} SOL withdrawn to ${data.address.slice(0, 8)}...`,
          );
          break;
        }
        case "balance": {
              ...
              <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
                ...
                <Card>
                  ...
                  <CardContent className="space-y-4">
                    ...
                    <Button
                      onClick={() =>
                        handleVaultOperation("withdraw", withdrawVault)
                      }
                      disabled={isLoading}
                      variant="destructive"
                      className="w-full"
                ...
                <Card>
                  ...
                  <CardContent className="space-y-4">
                    ...
                    <Button
                      onClick={() =>
                        handleVaultOperation("balance", balanceCheck)
                      }
                      disabled={isLoading}
                      variant="outline"
                      className="w-full"
                    ...
                    {vaultBalance !== null && (
                      <div className="mt-4 text-sm text-muted-foreground">
                        ...
                        <strong>{Number(vaultBalance)} SOL</strong>
                      </div>
                    )}
                  </CardContent>
                </Card>
