...
const STEPS = [
  {
    ...
    desc: "Sign in with your Solana wallet, enter your machine specs — CPU, RAM, storage, region. You'll get a registration key.",
    cta: "Register now",
    href: "/depin/register",
  },
  {
  ...
  },
  {
    ...
    desc: "Run the agent to join the DePIN pool. Earn SOL for every second of compute served to renters.",
    code: "axion start",
    cta: "View dashboard",
