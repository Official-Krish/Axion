    ...
    <Dialog open={isCredentialsOpen} onOpenChange={setIsCredentialsOpen}>
      <DialogContent className="max-w-2xl max-h-[90vh] overflow-hidden flex flex-col">
        <DialogHeader className="flex-shrink-0">
          ...
          <DialogDescription>
            Your virtual machine is now running. Save these credentials to
            ...
            <CardContent className="space-y-4">
              ...
              <div>
                  ...
                  <div className="flex space-x-2">
                    <Button
                      ...
                      onClick={() => {
                        ...
                        const file = new Blob([finalConfig?.privateKey || ""], {
                          type: "text/plain",
                        });
                ...
                <div className="bg-muted p-3 rounded font-mono text-xs">
                  {finalConfig?.privateKey?.slice(0, 30)}
                  <br />
                  <span className="text-muted-foreground">
                    [Key truncated for security]
                  </span>
                  <br />
                  -----END PRIVATE KEY-----
                </div>
              ...
              <div className="bg-amber-500/10 border border-amber-500/20 rounded-lg p-3">
                ...
                <div className="text-xs text-amber-600 dark:text-amber-400">
                  Save your private key and auth token securely. This is the
